...
/*Task 1: counterMaker()
  ...
  A: one is lexical and one isn't.
  
  2. Which of the two uses a closure? How can you tell?
  A: counter 1, function within a function
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     A: accessibility for one, for two when we are just running one instance.
*/
...
function scoreboard(cBGetInningScore, cBInning, number) {
  ...
  for (let i = 1; i < number; i++) {
    ...
    awayScore = awayScore + cBGetInningScore(cBInning);
